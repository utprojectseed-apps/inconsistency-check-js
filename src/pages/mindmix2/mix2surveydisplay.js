...
export default function Mindmix2SurveyDisplay() {
  ...
  const survey = useRef(new Mindmix2Survey());
  ...
  return (
    <div className="survey">
      <div className="no-print">
        ...
        <CSVReader parentCallback={handleUpload} gameId="mindmix2"/>
      </div>
